...
void BalboaInterface::begin() {
  Serial.println("BEGIN: clockPin=" + String(clockPin) + " displayPin=" + String(displayPin) + " buttonPin=" + String(buttonPin));

  Serial.println("BEGIN: pinMode clockPin INPUT_PULLDOWN...");
  pinMode(clockPin, INPUT_PULLDOWN);
  Serial.println("BEGIN: pinMode clockPin OK");

  Serial.println("BEGIN: pinMode displayPin INPUT_PULLDOWN...");
  pinMode(displayPin, INPUT_PULLDOWN);
  Serial.println("BEGIN: pinMode displayPin OK");

  Serial.println("BEGIN: pinMode buttonPin OUTPUT...");
  pinMode(buttonPin, OUTPUT);
  Serial.println("BEGIN: pinMode buttonPin OK");

  Serial.println("BEGIN: digitalWrite buttonPin LOW...");
  digitalWrite(buttonPin, LOW);
  Serial.println("BEGIN: digitalWrite OK");

  Serial.println("BEGIN: attachInterrupt...");
  attachInterrupt(clockPin, clockPinInterrupt, CHANGE);
  Serial.println("BEGIN: attachInterrupt OK - begin() complete");
}
